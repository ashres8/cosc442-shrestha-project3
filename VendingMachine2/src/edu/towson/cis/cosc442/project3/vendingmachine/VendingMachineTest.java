 ...
 *
 * @generatedBy CodePro at 3/4/18 4:32 PM
 * @author asims
...
public class VendingMachineTest {
	...
	public void testAddItem_1()
		...
		// add additional test code here
		assertEquals(item, fixture.getItem(code));
	}
	...
	public void testMakePurchase_5()
		...
		VendingMachineItem vi1 = new VendingMachineItem("Chip", 1.00);
		String code = "A";
		vendingMachine.balance = 2.0;
		vendingMachine.addItem(vi1, VendingMachine.A_CODE);
